...
<head>
    ...
    <!--====== Title ======-->
    <title>Flow Translate - Contact Us</title>
...
<body id="header">
                        ...
                        ">
                                <nav id="mobile-menu">
                                    <ul>
                                        ...
                                        <li><a href="{{ route('/') }}">Get a Quote</a></li>

                                        <li><a href="{{ route('/') }}">How We Work</a></li>
    ...
    <section class="breadcrumb-section pt-180 pb-180 bg_img" data-background="assets/images/banner/hero-banner-2.jpg"
            ...
            <div class="row mt-none-30">
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                    <div class="contact-info">
                        ...
                        <a href="tel:6502294621">(650) 229-4621</a>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                    <div class="contact-info">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 pl-50">
                    ...
                    <div class="contact-form">
                        <form action="{{ route('sendContactForm') }}" method="POST" id="contact-form">
                            @csrf
                            @method('POST')
                            ...
                            <div class="form-group mt-25">
                                <input type="email" required name="email" id="mail" placeholder="Email Address">
                            </div>
                            <div class="form-group mt-25">
                                <textarea name="message" required id="message" placeholder="Your Message"></textarea>
                            </div>
                            <div class="form-group mt-25 mx-auto">

                                <div class="g-recaptcha" data-sitekey="6Ldw1WAjAAAAAPCSidRXZg7jDuIG7_GWikO24ElP"></div>
                            </div>
                            <button type="submit" class="site-btn site-btn__2 mt-15"><span class="icon icon__black"><i
                                        class="far fa-arrow-right"></i></span> Contact
                                us</button>
