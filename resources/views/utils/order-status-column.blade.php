...
{{-- Status for Users --}}
@if ($order->want_quote == 0 && $order->translation_status == 0 && $order->is_cancelled == 0)
<div class="w-full btn btn-warning">
    Translation Requested
</div>
@elseif ($order->want_quote == 1 && $order->is_cancelled == 0)
<div class="w-full btn btn-warning">
    Quote Requested
</div>
@elseif($order->want_quote == 2 && $order->is_cancelled == 0)
...
@elseif ($order->translation_status == \App\Enums\TranslationStatusEnum::COMPLETED && $order->is_cancelled == 0)
<div class="w-full btn btn-success">
...
@elseif ($order->want_quote == 0 && ($order->user->role_id == 1 || $order->user->role_id == 2))
<div class="w-full btn btn-warning">
    Translation Requested
</div>
