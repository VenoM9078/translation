                        ...
                        <table id="proofReadTable" class="table table-striped hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap">{{ $translation->feedback }}</td>
                                    <td>
                                    ...
                                    <td class="whitespace-nowrap">${{ $translation->contractor->proofreader_rate }}
                                    </td>
                                    <td class="whitespace-nowrap">${{ $translation->total_payment }}</td>
                                    <td class="whitespace-nowrap">${{ $translation->rate }}</td>
                                    <td class="whitespace-nowrap">{{ $translation->proof_read_adjust_note }}</td>
                                    <td class="whitespace-nowrap">{{ $translation->proof_read_paid }}</td>
                                    ...
                                    <!-- BEGIN: Modal Content -->
                                    <div id="proofread-modal-accept-{{ $key }}" class="modal" tabindex="-1"
                                        aria-hidden="true">
                                    ...
                                    <!-- BEGIN: Modal Content -->
                                    <div id="proofread-modal-reject-{{ $key }}" class="modal" tabindex="-1"
                                        aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-body p-0">
            ...
            $.fn.dataTable.ext.search.push(
                function(settings, data, dataIndex) {
                    ...
                    if (isPendingChecked && data[12] == 'Pending') {
                        return true;
                    } else if (isCompletedChecked && data[5] == 'Completed') {
                        return true;
                    } else if (isOnGoingChecked && data[5] == 'On-Going') {
                        console.log("YEs")
                        return true;
                    }
