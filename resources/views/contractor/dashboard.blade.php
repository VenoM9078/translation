    ...
    <div class="grid grid-cols-12 gap-6">
            ...
            <a href="{{ route('contractor.translations.pending') }}">
                <div class="report-box zoom-in">
                    <div class="box p-5">
                        ...
                        <div class="text-3xl font-medium leading-8 mt-6">Translations</div>
        ...
        <div class="col-span-4 sm:col-span-6 xl:col-span-3 intro-y">
            <div class="report-box zoom-in">
                <div class="box p-5">
                    <div class="flex">
                        <i data-lucide="book" class="report-box__icon text-danger"></i>

                    </div>
                    <div class="text-3xl font-medium leading-8 mt-6">Proofreads</div>
        ...
        <div class="col-span-4 sm:col-span-6 xl:col-span-3 intro-y">
            <div class="report-box zoom-in">
                <div class="box p-5">
                    <div class="flex">
                        <i data-lucide="coffee" class="report-box__icon text-success"></i>
                    </div>
                    <div class="text-3xl font-medium leading-8 mt-6">Interpretations</div>
