    ...
    <div class="col-span-12 mt-8">
        ...
        <div class="intro-y box">
            <div id="vertical-form" class="p-5">
                <div class="preview">
                    <div>
                        <form action="{{ route('contractor.submit-proof-read') }}" accept-charset="utf-8" method="post"
                            enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <input type="hidden" name="id" value="{{$proofReaderOrders->id}}">
                            <label for="">Enter your feedback</label>
                            <textarea name="feedback" class="mt-2 form-control" rows="3" placeholder=""></textarea>
