                ...
                <div class="row">
                                ...
                                <nav id="mobile-menu">
                                    <ul>
                                        ...
                                        <li><div style="
                                            ...
                                            margin-left: 30px;
                                            margin-top: 23px;
                                        " id="google_translate_element2"></div></li>
                                    </ul>
                                </nav>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 my-auto">
                        <div class="lang-quote lang-quote__2">
                            ...
                            <a href="{{ route('login') }}" style="padding: 17px !important;" class="quote-btn">Translate your Document</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row mt-none-40">
                        <div class="col-xl-6 mt-40">
                            <div class="ab__box">
                                ...
                                <p>To be the channel through which information can "flow" seamlessly and smoothly between different cultures and languages so that the true meaning of messages are transmitted and understood.</p>
                            </div>
                        </div>
                        <div class="col-xl-6 mt-40">
                            <div class="ab__box">
                                ...
                                <p>FLOW Translations is founded by two professionals who understand first hand the challenge of cross-cultural communication and interaction.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mt-40">
                    <div class="wp-box reverse-col">
                        <div class="wp-box__content">
                            ...
                            <p>Have a document you need translated? Fill in the details, attach the document and wait for the magic to happen!</p>
                        </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 mt-40">
                    <div class="wp-box">
                        ...
                        <div class="wp-box__content">
                            ...
                            <p>Our team will get in contact with you and send you an appropriate invoice for your order - once you pay a reasonable fees, your order will be processed!</p>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-6 col-md-6 mt-40">
                    <div class="wp-box reverse-col">
                        <div class="wp-box__content">
                            ...
                            <p>You will be able to track the entire process of your translation and once it is translated and proofread - you can download the translation.</p>
                        </div>
