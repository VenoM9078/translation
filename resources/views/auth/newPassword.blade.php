                    ...
                    <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        ...
                        <form method="POST" action="{{ route('password.update') }}">
                            ...
                            <div class="intro-x mt-8">
                                <input required type="email" name="email" class="intro-x login__input form-control py-3 px-4 block" placeholder="Enter Email Address">
                            </div>
                            <div class="intro-x mt-8">
                                <input required type="password" name="password" class="intro-x login__input form-control py-3 px-4 block" placeholder="Enter New Password">
                            </div>
                            <div class="intro-x mt-8">
                                <input required type="password" name="password_confirmation" class="intro-x login__input form-control py-3 px-4 block" placeholder="Confirm Password">
                            </div>
                            <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                                <button style="width: 200px;" type="submit" class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Reset Password</button>
