                                ...
                                <div class="w-full">
                                    ...
                                    <div class="mt-1">
                                        <select name="language" data-placeholder="Select a language"
                                            ...
                                            <option value="{{$interpretation->language}}">{{$interpretation->language}}
                                            </option>
                            ...
                            <div class="mt-5 mb-5">
                                <div class="flex mt-2 mb-2 gap-2">
                                    ...
                                    <div class="mt-2 w-full">
                                        ...
                                        <select name="session_format" data-placeholder="Select Session Format"
                                            class="tom-select w-full">
                                            <option value="{{$interpretation->session_format}}">
                                                {{$interpretation->session_format}}</option>
                                    ...
                                    <div class="mt-2 w-full">
                                        ...
                                        <select name="type" data-placeholder="Select Address/Link"
                                            ...
                                            <option value="{{$interpretation->type}}">{{$interpretation->type}}</option>
                                ...
                                <div class="mt-5 mb-5">
                                    ...
                                    <textarea name="session_topics"
                                        class="intro-x login__input form-control block h-20">{{$interpretation->session_topics}}</textarea>
                                </div>
                                <div class="mt-5 mb-5">
                                    <label>Message</label>
                                    <textarea name="message"
                                        class="intro-x login__input form-control block h-20">{{$interpretation->message}}</textarea>
                                </div>
