...
<div class="col-span-12 mt-8">
    ...
    <div class="alert alert-warning show mb-2" role="alert">
        ...
        <div class="mt-3">Thank you for signing up with us! We see that you requested to create an Institute by the name
    ...
    <div class="alert alert-warning show mb-2" role="alert">
        ...
        <div class="mt-3">
            ...
            <span class="font-bold">Institute Name:</span> @foreach(Auth::user()->user_requests as $request)
