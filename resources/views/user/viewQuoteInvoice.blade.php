    ...
    <div class="intro-y box overflow-hidden mt-5">
        ...
        <div class="flex flex-col lg:flex-row border-b px-5 sm:px-20 pt-10 pb-10 sm:pb-20 text-center sm:text-left">
            ...
            <div class="mt-10 lg:mt-0 lg:ml-auto lg:text-right">
                ...
                <div class="text-lg text-pending font-medium mt-2">Created At:
                    {{ $interpretation->created_at->timezone('America/Los_Angeles') }}</div>
            </div>
        </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="border-b dark:border-darkmode-400">
                                <div class="font-medium whitespace-nowrap">{{ $interpretation->start_time }}
                                </div>
                            </td>
                            <td class="border-b dark:border-darkmode-400">
                                <div class="font-medium whitespace-nowrap">{{ $interpretation->end_time }}
                                </div>
                            </td>
                            <td class="border-b dark:border-darkmode-400">
                            ...
                            <td class="border-b dark:border-darkmode-400">
                                <div class="font-medium whitespace-nowrap">${{ $interpretation->quote_price }}
                                </div>
                            </td>
        ...
        <div class="px-5 sm:px-20 pb-10 sm:pb-20 flex flex-col-reverse sm:flex-row">
            ...
            <div class="text-center sm:text-right sm:ml-auto">
                ...
                <div class="text-xl text-primary font-medium mt-2">${{ $interpretation->quote_price }}</div>
