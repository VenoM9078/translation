            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    <div class="intro-y box mt-5">
                        <div class="p-5">
                            <form action="{{ route('user.upgrade-inst-admin') }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input required type="text" name="institute_name" class="mt-2 form-control py-3 px-4"
