                                ...
                                <tbody>
                                    @foreach ($orders as $order)
                                        <tr>
                                            ...
                                            <!-- BEGIN: Modal Content -->
                                            <div id="c-note-modal-preview{{ $order->id }}" class="modal"
                                                tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-body p-0">
                                                            <div class="p-5 text-center"> <i data-lucide="bookmark"
                                                                ...
                                                                <div class="w-full text-left">
                                                                    <label for="order-form-21" class="form-label">Quote
                                                                        Message:</label>
                                                                    <textarea id="order-form-2" type="text" class="form-control" disabled>{{ $order->c_adjust_note }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <td class="whitespace-nowrap">
                                        ...
                                        @elseif ($order->contractorOrder->is_accepted == 1 && $order->translation_status
                                        == 0)
                                        <div class="w-full">
                                            Translation In Progress
                                        </div>
                                        @elseif ($order->translation_status ==
                                        \App\Enums\TranslationStatusEnum::COMPLETED)
                                        <div class="w-full">
