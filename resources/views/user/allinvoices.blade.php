                        ...
                        <table id="myTable" class="table table-striped hover" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="whitespace-nowrap">{{ App\Helpers\HelperClass::convertDateToCurrentTimeZone($invoice->created_at, request()->ip()) }}</td>
                                    <td class="whitespace-nowrap">
                                        <div>
                                            ...
                                            <button class="btn btn-success mr-1 mb-2"> Payment Paid</button>
                                            @elseif ($invoice->order->invoiceSent == 1 &&
                                            $invoice->order->paymentStatus
                                            ==
                                            0)
                                            <a href="{{ route('viewInvoice', $invoice->order->invoice->id) }}"
                                                class="btn btn-warning mr-1 mb-2"> View Invoice
                                            </a>
                                            @elseif ($invoice->order->invoiceSent == 1 &&
                                            $invoice->order->paymentStatus
                                            ==
                                    ...
                                    <td class="whitespace-nowrap">
                                        <div class="flex gap-2">
                                            ...
                                            @endif
                                            <div><a href="{{ route('generatePDFInvoice', $invoice->id) }}"
                                                    class="btn btn-primary">Download Invoice</a></div>
                                        </div>
                                    </td>
