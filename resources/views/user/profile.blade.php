                            ...
                            @if ($user->role_id == 1)
                                <div class="w-full">
                                    ...
                                    @foreach ($user->institute as $institute)
                                        <input id="change-password-form-1" type="text" class="form-control"
                                            name="name" value="{{ $institute->name }}" disabled>
                                    @endforeach
                                </div>
                            @elseif($user->role_id == 2)
                                <div class="w-full">
                                    ...
                                    @if (isset($user->institute_managed))
                                        <input id="change-password-form-1" type="text" class="form-control"
                                            name="name" value="{{ $user->institute_managed->name }}">
                                    @else
                                        <input id="change-password-form-1" type="text" class="form-control"
                                            name="name" value="N/A">
                                    @endif
                                ...
                                <div class="w-full">
                                    ...
                                    @if (isset($user->institute_managed))
                                        <input id="change-password-form-2" name="passcode" type="text"
                                            class="form-control" value="{{ $user->institute_managed->passcode }}">
                                    @else
                                        <input id="change-password-form-2" name="passcode" type="text"
                                ...
                                @if (isset($user->institute_managed))
                                    <div class="w-full m-1">
                                        <div class="flex justify-between gap-4 items-center">
                                            <div class="mt-2">
                                                <label for="checkbox-switch-7" class="form-label">Member Approval
                                                    Needed</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <input id="checkbox-switch-7" name="member_approval_needed" class="form-check-input" type="checkbox"
                                                {{ $user->institute_managed->member_approval_needed == 1 ? 'checked' : '' }}
                                                >
                                            </div>
                                        </div>
                                    </div>
