...
<div class="error-page flex flex-col lg:flex-row items-center justify-center h-screen text-center lg:text-left">
    ...
    <div class="mt-10 lg:mt-0">
        ...
        <div class="intro-x text-xl lg:text-3xl font-medium mt-5">Your late payment request has been submitted!</div>
        <div class="intro-x text-lg mt-3">Our team will examine your request and get back to you as soon as possible!</div>
