                                    ...
                                    <td class="whitespace-nowrap">
                                        <div class="flex gap-1">
                                            ...
                                            <a href="{{ route('admin.showSubmitQuote', $interpretation->id) }}"
                                                ...
                                                Invoice</a>
                                            {{-- @elseif ($interpretation->wantQuote == 0 &&
                                            $interpretation->invoiceSent ==
                                            ...
                                            <div class="text-center">
                                                <form action="{{ route('admin-cancelInterpretation') }}" method="POST">
                                                    @csrf
                                                    ...
                                                    <div class="p-5 text-center"> <i data-lucide="bookmark"
                                                        ...
                                                        <div class="w-full text-left">
                                                            ...
                                                            <textarea id="order-form-21" type="text"
                                                                class="form-control"
                                                                disabled>{{ $interpretation->quote_description }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="modal-body p-0">
                                                    <div class="p-5 text-center"> <i data-lucide="bookmark"
                                                        ...
                                                        <div class="w-full text-left">
                                                            ...
                                                            <textarea id="order-form-21" type="text"
                                                                class="form-control"
                                                                disabled>{{ $interpretation->message }}</textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-body p-0">
                                                ...
                                                <div class="loader text-center" role="status" id="loader-{{$interpretation->id}}" style="display: none">
