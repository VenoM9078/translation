                    ...
                    <form action="{{ route('admin.interpretation.update', $interpretation->id) }}" method="post"
                        ...
                        <div class="intro-x mt-4">
                            ...
                            <div class="mt-5">
                                ...
                                <input type="date" name="interpretationDate"
                            ...
                            <div class="mt-5">
                                ...
                                <select name="session_format" data-placeholder="Select Session Format"
                                    ...
                                    <option value="In-Person" {{ $interpretation->session_format == 'In-Person' ?
                                        'selected' : '' }}>In-Person
                                    </option>
                                    <option value="Virtual Call" {{ $interpretation->session_format == 'Virtual Call' ?
                                        'selected' : '' }}>
                                        Virtual Call</option>
                                </select>
                            </div>
