...
<div class="col-span-12 mt-8">
    ...
    <div class="intro-y box">
        <div id="vertical-form" class="p-5">
            <div class="preview">
                <div>
                  <form action="{{ route('sendDocumentsToProofReader') }}" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="intro-x mt-4">
                        <input type="hidden" name="order_id" value="{{ $order->id }}">
                        <input type="email" name="proofreader_email" class="intro-x login__input form-control py-3 px-4 block" required placeholder="Enter Proofreader's Email">
