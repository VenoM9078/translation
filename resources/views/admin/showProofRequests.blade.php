                    ...
                    <table id="myTable" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if($proofReadRequest->order->user->casemanager == '' &&
                                $proofReadRequest->order->user->access_code == '')
                                <td class="whitespace-nowrap">N/A</td>
                                <td class="whitespace-nowrap">N/A</td>
                                @else
                                <td class="whitespace-nowrap">{{ $proofReadRequest->order->user->casemanager }}</td>
                                <td class="whitespace-nowrap">{{ $proofReadRequest->order->user->access_code }}</td>
                                @endif
