                    ...
                    <table id="myTable" class="table table-striped" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if($invoice->order->user->casemanager == '' && $invoice->order->user->access_code ==
                                '')
                                <td class="whitespace-nowrap">N/A</td>
                                <td class="whitespace-nowrap">N/A</td>
                                @else
                                <td class="whitespace-nowrap">{{ $invoice->order->user->casemanager }}</td>
                                <td class="whitespace-nowrap">{{ $invoice->order->user->access_code }}</td>
                                @endif
                                ...
                                <td class="whitespace-nowrap">
                                    <div class="flex  items-center">
                                        <a href="{{ route('invoice.edit',$invoice->id) }}" class="btn btn-warning mr-1">
