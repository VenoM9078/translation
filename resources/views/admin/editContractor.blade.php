        ...
        <div id="vertical-form" class="p-5">
            <form action="{{route('admin.updateContractor')}}" method="post">
                ...
                <div class="preview">
                        ...
                        <div class="container mt-8">
                            <div class="flex flex-wrap -mx-3">
                                ...
                                <div class="w-1/3 px-3 mb-6 md:mb-0">
                                    ...
                                    <select style="width: 100%" name="translator_languages[]"
                                        aria-placeholder="Choose your Languages" class="tom-select w-full" multiple>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="number" name="translation_rate" step="0.0001"
                                            class="w-full intro-x login__input form-control py-3 px-4 block mt-4"
                                ...
                                <div class="w-1/3 px-3 mb-6 md:mb-0">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="number" name="interpretation_rate" step="0.0001"
                                            class="w-full intro-x login__input form-control py-3 px-4 block mt-4"
                                ...
                                <div class="w-1/3 px-3 mb-6 md:mb-0">
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <input type="number" name="proofreader_rate" step="0.0001"
                                            class="w-full intro-x login__input form-control py-3 px-4 block mt-4"
                    ...
                    <input type="submit" class="btn btn-primary bg-blue-600 mt-5" value="Update Contractor">
                </div>
            </form>
        </div>
    </div>
