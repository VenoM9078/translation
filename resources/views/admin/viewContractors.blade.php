                                        ...
                                        <tr>
                                            ...
                                            @if ($contractor->address != '')
                                                <td class="whitespace-nowrap">
                                                    {{ mb_strimwidth($contractor->address, 0, 20, '...') }}</td>
                                            @else
                                            ...
                                            <td class="whitespace-nowrap">
                                                {{ implode(
                                                    ', ',
                                                    $contractor->languages->where('is_translator', 1)->pluck('language')->toArray(),
                                                ) }}
                                            </td>
                                            ...
                                            <td class="whitespace-nowrap">
                                                {{ implode(
                                                    ', ',
                                                    $contractor->languages->where('is_proofreader', 1)->pluck('language')->toArray(),
                                                ) }}
                                            </td>
                                            ...
                                            <td class="whitespace-nowrap">
                                                {{ implode(
                                                    ', ',
                                                    $contractor->languages->where('is_interpreter', 1)->pluck('language')->toArray(),
                                                ) }}
                                            </td>
                                            <td class="whitespace-nowrap">${{ $contractor->interpretation_rate }}</td>
                                            <td class="whitespace-nowrap">
                                                <!-- Your Action buttons here -->
                                                <a href="{{ route('admin.viewContractor', $contractor->id) }}"
