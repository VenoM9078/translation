...
<body class="py-5">
    ...
    <div class="mobile-menu md:hidden">
        ...
        <ul class="scrollable__content py-2">
            ...
            <li>
                <a href="{{ route('admin.pending') }}" class="menu">
                    <div class="menu__icon"> <i data-lucide="home"></i> </div>
            ...
            <li>
                <a href="{{ route('admin.newTranslationOrder') }}" class="menu">
                    <div class="menu__icon"> <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="32"
                            height="32" fill="white" viewBox="0 0 24 24" id="language">
                            <path
                    ...
                    <div class="menu__title"> Translations </div>
                </a>
            </li>
            <li>
                <a href="{{ route('admin.newInterpretation') }}" class="menu">
                    <div class="menu__icon"> <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="32"
                            height="32" fill="white" viewBox="0 0 128 128" id="meeting">
                            ...
                            <path
                                d="M37 90.46v16.505A4.032 4.032 0 0 0 41.on02 111H46a9.008 9.008 0 0 0 6 8.475V126a2 2 0 0 0 4 0v-6h17v6a2 2 0 0 0 4 0v-6.95a9.002 9.002 0 0 0 5-8.05h4.98a4.032 4.032 0 0 0 4.02-4.035V90.46C91 81.159 82.76 73 73.366 73H54.635C45.24 73 37 81.16 37 90.46zM54.635 77h18.731A13.903 13.903 0 0 1 87 90.46L86.983 107 82 106.996V91a5.006 5.006 0 0 0-5-5H51a5.006 5.006 0 0 0-5 5v15.969l-5-.004V90.46C41 83.29 47.372 77 54.635 77zM29 108V80h-4v28a2 2 0 0 0 4 0Z">
                            </path>
                        </svg> </div>
                    <div class="menu__title"> Interpretations </div>
                </a>
            </li>
            <li>
                <a href="{{ route('admin.viewContractors') }}" class="menu">
                    <div class="menu__icon">
                        <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" width="32" height="32"
                            fill="white" viewBox="0 0 128 128" id="engineer">
                            <path
                    ...
                    <div class="menu__title"> Contractors </div>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="{{ route('viewQuoteRequests') }}" class="menu">
                    <div class="menu__icon"> <i data-lucide="message-square"></i> </div>
                    <div class="menu__title"> Quote Requests </div>
                </a>
            </li>
            <li>
                <a href="{{ route('viewFeedback') }}" class="menu">
                    <div class="menu__icon"> <i data-lucide="award"></i> </div>
                    <div class="menu__title"> Feedbacks </div>
                </a>
            </li>
            <li>
                <a href="{{ route('viewMessages') }}" class="menu">
    ...
    <div class="flex mt-[4.7rem] md:mt-0">
        ...
        <nav class="side-nav">
            ...
            <ul>
                ...
                <li>
                    <a href="javascript:;"
                        class="{{ Route::getCurrentRoute()->uri == 'admin/pending' || Route::getCurrentRoute()->uri == 'admin/new-translation-order' ? 'side-menu side-menu--active' : 'side-menu' }}">
                    ...
                    <ul class="">
                        <li>
                            <a href="{{ route('admin.newTranslationOrder') }}" class="side-menu">
                ...
                <li>
                    <a href="javascript:;"
                        class="{{ Route::getCurrentRoute()->uri == 'admin/ongoing-interpretations' || Route::getCurrentRoute()->uri == 'admin/new-interpretation' ? 'side-menu side-menu--active' : 'side-menu' }}">
                        <div class="side-menu__icon"><svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"
                    ...
                    <ul class="">
                        <li>
                            <a href="{{ route('admin.newInterpretation') }}" class="side-menu">
                                <div class="side-menu__icon"> <i data-lucide="activity"></i> </div>
                                <div class="side-menu__title"> New Order </div>
                            </a>
                        </li>
