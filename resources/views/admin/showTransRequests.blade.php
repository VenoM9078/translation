                            ...
                            <tbody>
                                @foreach ($translationRequests as $translationRequest)
                                    <tr>
                                        ...
                                        @if ($translationRequest->order->user->casemanager == '' && $translationRequest->order->user->access_code == '')
                                            <td class="whitespace-nowrap">N/A</td>
                                            <td class="whitespace-nowrap">N/A</td>
                                        @else
                                            <td class="whitespace-nowrap">
                                                {{ $translationRequest->order->user->casemanager }}</td>
                                            <td class="whitespace-nowrap">
                                                {{ $translationRequest->order->user->access_code }}</td>
                                        @endif
                                        ...
                                        <td class="whitespace-nowrap">
                                            ...
                                            class="btn btn-warning mr-1 mb-2"> <i data-lucide="download"
                                                ...
                                                @if ($translationRequest->translation_status == 0)
                                                    <a href="{{ route('changeTranslationRequestStatus', $translationRequest->order->id) }}"
