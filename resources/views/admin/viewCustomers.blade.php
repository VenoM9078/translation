                                    ...
                                    <td class="whitespace-nowrap">
                                        <div class="flex gap-2 items-center">
                                            ...
                                            <div class="text-center">
                                                <button class="btn btn-danger" data-tw-toggle="modal"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-body p-0">
                                                    ...
                                                    <div class="px-5 pb-8 text-center inline-flex items-stretch"
                                                        style="text-align: center;margin: auto !important;width: 100%;position: relative;justify-content: center;">
                                                        <form {{-- @if (isset($user->institute) && $user->institute !=
                                                            null) --}}
                                                            action="{{ route('institute.delete',
                                                            $user->institute[0]->id) }}"
                                                            {{-- @endif --}} method="POST">
                                                            @csrf
                                                            @method('DELETE')
