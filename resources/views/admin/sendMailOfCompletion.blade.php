...
<div class="col-span-12 mt-8">
    ...
    <div class="intro-y box">
        <div id="vertical-form" class="p-5">
            <div class="preview">
                <div>
                  <form action="{{ route('sendDocumentsToUser') }}" accept-charset="utf-8" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="intro-x mt-4">
                        ...
                        <input type="email" name="email" readonly="readonly" class="intro-x login__input form-control py-3 px-4 block" value="{{ $order->user->email }}">
                        ...
                        <div class="file-upload mt-6">
                            <div class="file-select">
                              <div class="file-select-button" id="fileName">Upload Translated Document(s)</div>
